            ...
            <div className="flex flex-wrap justify-center gap-3">
              {socialLinks.map((social, index) => {
                ...
                return (
                 ...
                 bg-blue-400/10 border-2 border-blue-400 rounded-full text-blue-400
                 ...
                 hover:shadow-lg  hover:shadow-blue-400/25"
                  ...
                  >
                    {SocialIcon && (
                      <SocialIcon className="text-xl relative z-10 group-hover:text-white transition-colors duration-300" />
                    )}
                    <span
